...
var NintendoAuth = /*#__PURE__*/function () {
  ...
  return _createClass(NintendoAuth, [{
    ...
    value: function generateAuthUrl() {
      ...
      var state = this.base64UrlEncode(crypto__default["default"].randomBytes(36));
      var verifier = this.base64UrlEncode(crypto__default["default"].randomBytes(32));
      var challenge = this.base64UrlEncode(crypto__default["default"].createHash('sha256').update(verifier).digest());
      ...
      return {
        authUrl: "https://accounts.nintendo.com/connect/1.0.0/authorize?".concat(params),
        state: state,
        verifier: verifier
      };
    }
    ...
    key: "exchangeCodeForSessionToken",
    value: (function () {
      var _exchangeCodeForSessionToken = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(sessionTokenCode, verifier) {
        var params, response;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              _context.n = 1;
              return axios__default["default"].post('https://accounts.nintendo.com/connect/1.0.0/api/session_token', params.toString(), {
                headers: {
            ...
            case 1:
              ...
              return _context.a(2, this.sessionToken);
          }
        }, _callee, this);
      }));
      function exchangeCodeForSessionToken(_x, _x2) {
        return _exchangeCodeForSessionToken.apply(this, arguments);
      }
      return exchangeCodeForSessionToken;
    }())
  }, {
    key: "base64UrlEncode",
    ...
    key: "authenticate",
    value: (function () {
      var _authenticate = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              ...
              _context2.n = 2;
              return axios__default["default"].post('https://accounts.nintendo.com/connect/1.0.0/api/token', params.toString(), {
                headers: {
                  'Content-Type': 'application/x-www-form-urlencoded',
                  'User-Agent': 'Allow2Automate/1.0.0'
                }
    ...
    value: (function () {
      var _ensureValidToken = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            ...
            case 1:
              return _context3.a(2, this.accessToken);
          }
        }, _callee3, this);
      }));
    ...
    key: "getHeaders",
    value: (function () {
      var _getHeaders = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 1:
              headers = _context.v;
              _context.n = 2;
              return axios__default["default"].post("".concat(this.baseURL, "/v2/actions/user/fetchOwnedDevices"), {}, {
                headers: headers
              });
            case 2:
              response = _context.v;
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            ...
            case 1:
              headers = _context2.v;
              _context2.n = 2;
              return axios__default["default"].post("".concat(this.baseURL, "/v2/actions/user/fetchOwnedDevice?deviceId=").concat(deviceId), {}, {
                headers: headers
              });
            case 2:
              response = _context2.v;
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            ...
            case 1:
              headers = _context3.v;
              _context3.n = 2;
              return axios__default["default"].post("".concat(this.baseURL, "/v2/actions/playSummary/fetchDailySummaries?deviceId=").concat(deviceId), {}, {
                headers: headers
              });
            case 2:
        ...
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            ...
            case 1:
              headers = _context4.v;
              _context4.n = 2;
              return axios__default["default"].post("".concat(this.baseURL, "/v2/actions/parentalControlSetting/fetchParentalControlSetting?deviceId=").concat(deviceId), {}, {
                headers: headers
              });
            case 2:
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            ...
            case 1:
              headers = _context5.v;
              _context5.n = 2;
              return axios__default["default"].post("".concat(this.baseURL, "/v3/actions/parentalControlSetting/updatePlayTimer"), {
                deviceId: deviceId,
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            ...
            case 1:
              headers = _context6.v;
              _context6.n = 2;
              return axios__default["default"].post("".concat(this.baseURL, "/v2/actions/device/updateExtraPlayingTime"), {
                deviceId: deviceId,
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.n) {
            ...
            case 1:
              headers = _context7.v;
              _context7.n = 2;
              return axios__default["default"].post("".concat(this.baseURL, "/v2/actions/parentalControlSetting/updateRestrictionLevel"), {
                deviceId: deviceId,
...
exports.FunctionalRestrictionLevel = FunctionalRestrictionLevel;
exports.NintendoAuth = NintendoAuth;
exports.NintendoParentalAPI = NintendoParentalAPI;
exports.PlayTimeMonitor = PlayTimeMonitor;
exports.RestrictionMode = RestrictionMode;
exports.TimerMode = TimerMode;
