...
var NintendoAuth = /*#__PURE__*/function () {
  ...
  return _createClass(NintendoAuth, [{
    ...
    value: function generateAuthUrl() {
      ...
      var state = this.base64UrlEncode(crypto.randomBytes(36));
      var verifier = this.base64UrlEncode(crypto.randomBytes(32));
      var challenge = this.base64UrlEncode(crypto.createHash('sha256').update(verifier).digest());
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              _context.n = 1;
              return axios.post('https://accounts.nintendo.com/connect/1.0.0/api/session_token', params.toString(), {
                headers: {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              ...
              _context2.n = 2;
              return axios.post('https://accounts.nintendo.com/connect/1.0.0/api/token', params.toString(), {
                headers: {
                  'Content-Type': 'application/x-www-form-urlencoded',
                  'User-Agent': 'Allow2Automate/1.0.0'
                }
