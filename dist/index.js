  ...
  return _createClass(TabContent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default["default"].createElement("div", {
        ...
        color: "textSecondary",
        paragraph: true
      }, this.state.accounts && this.state.accounts.length > 1 ? 'Multiple accounts found. Select the one with parental controls:' : 'Select the account to link:'), /*#__PURE__*/React__default["default"].createElement(List__default["default"], null, this.state.accounts.map(function (account, idx) {
